    ...
    render() {
        ...
        return (config.empty ?
            <Svg xmlns="http://www.w3.org/2000/svg"
                ...
                <Path fill={config && config.color ? config.color : color.fontTitleColor} d="M503.401,228.884l-43.253-39.411V58.79c0-8.315-6.741-15.057-15.057-15.057H340.976c-8.315,0-15.057,6.741-15.057,15.057
            ...
            <Svg xmlns="http://www.w3.org/2000/svg"
                ...
                <Path fill={config && config.color ? config.color : color.fontTitleColor} d="M503.402,228.885L273.684,19.567c-10.083-9.189-25.288-9.188-35.367-0.001L8.598,228.886
