...
export default class User extends React.Component {
    render() {
        return (
            <Svg xmlns="http://www.w3.org/2000/svg" height="30pt" width="30pt" viewBox="0 0 299.997 299.997">
                <Path fill={color.fontTitleColor} d="M149.996,0C67.157,0,0.001,67.158,0.001,149.997c0,82.837,67.156,150,149.995,150s150-67.163,150-150
