...
//import {getListQuoteFromApi} from "../../API/CocktailAPI";
...
export default class QuoteList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {quotes: [] = dico, isLoading: false, choosenLabel: ''};
    }
        ...
        return (
            <View style={styles.main_container}>
                <FlatList
                    ...
                    renderItem={({item}) => <Item quote={item} displayDetail={this._displayDetail}/>}
